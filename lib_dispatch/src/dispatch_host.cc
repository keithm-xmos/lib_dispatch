...
dispatch_queue_t *dispatch_queue_create(size_t length, size_t thread_count,
  ...
  //   queue->thread_tasks = malloc(sizeof(dispatch_thread_task_t) *
  //   thread_count);

  //   // allocate thread data
  //   queue->thread_data = malloc(sizeof(dispatch_thread_data_t) *
  //   thread_count);
...
void dispatch_queue_init(dispatch_queue_t *ctx) {
  ...
  //     chanend_set_dest(queue->thread_chanends[i],
  //     queue->thread_data[i].cend);
  //     chanend_set_dest(queue->thread_data[i].cend,
  //     queue->thread_chanends[i]);
...
void dispatch_queue_async_task(dispatch_queue_t *ctx, dispatch_task_t *task) {
  ...
  //     // send task to worker
  //     chan_out_buf_byte(queue->thread_chanends[worker_index], (void
  //     *)&task[0],
